...
public class Main2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentThatStartedThisActivity != null) {
            if (intentThatStartedThisActivity.hasExtra("UserObject")) {
                mUser = (UserClass) intentThatStartedThisActivity.getExtras().getParcelable("UserObject");
            }
        }
        ...
        mUserMail = (TextView)header.findViewById(R.id.user_mail);
        mUserMail.setText(mUser.mMail.toString());
        mUserName = (TextView)header.findViewById(R.id.user_name);
        mUserName.setText(mUser.mName.toString());
